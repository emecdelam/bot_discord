...
class Streak(BotFeature):
    ...
    async def daily_message(self) -> None:
        ...
        content = ask_chat("""I want you to generate a daily message for my users to ask them if they did their tasks (called TP) and i want you to end the message with science/math fun fact/joke.
